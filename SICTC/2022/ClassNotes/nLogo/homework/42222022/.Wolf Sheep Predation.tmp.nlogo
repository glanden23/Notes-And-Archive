...
to go
  ...
  ask humans [
    ...
    eat-wolf ; humans eat a wolf on their patch
    death ; humans die if they run out of energy
    reproduce-humans ; humans reproduce at a random rate governed by a slider
  ]
...
"humans" 1.0 0 -14454117 true "" "plot count humans"
