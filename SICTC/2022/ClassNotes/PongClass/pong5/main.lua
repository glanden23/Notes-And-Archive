...
function love.draw()
    ...
    love.graphics.printf(math.floor(player1.y) + 10 .." > "..math.floor(ball.y),0,60, VIRTUAL_WIDTH, 'center')
    love.graphics.printf(math.floor(player1.y) - 10 .." < "..math.floor(ball.y),0,90, VIRTUAL_WIDTH, 'center')
