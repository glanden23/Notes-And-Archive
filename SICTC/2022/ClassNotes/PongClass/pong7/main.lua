...
function love.load()
    ...
    mainMusic = love.audio.newSource("loopedMusic.mp3","stream")
    mainMusic:setVolume(0.5)
    hit = love.audio.newSource("hit.mp3","static")
    point = love.audio.newSource("point.mp3","static")
end
...
function love.draw()
    ...
    love.graphics.setColor(220,20,60)
    love.graphics.printf(player1.score.."/5",50,0,VIRTUAL_WIDTH,"left")
    player1:render()
    love.graphics.setColor(0,191,255)
    love.graphics.printf(player2.score.."/5",-50,0,VIRTUAL_WIDTH,"right")
    player2:render()
